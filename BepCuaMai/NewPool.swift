...
struct NewPool: View {
  ...
  func fetchMenus() {
    isLoading = true
    guard let url = URL(string: "https://e099-118-70-175-236.ngrok-free.app/menu") else { return }
  ...
  func onUpdate(_ id: String, _ number: Int, _ isStar: Bool?) {
    guard let url = URL(string: "https://e099-118-70-175-236.ngrok-free.app/menu/update/" + id) else { return }
